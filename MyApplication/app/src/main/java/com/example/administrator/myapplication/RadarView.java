...
public class RadarView extends View {
    ...
    private String[] titles = {"C#","C/C++","Java","Python","GO","Android"};
    ...
    public boolean onTouchEvent(MotionEvent event) {
       // Log.d("onTouchEvent","123");
        boolean flag = false;
        int action = event.getAction();
        switch (action){
            case MotionEvent.ACTION_DOWN:
                flag = true;
                Log.d("onTouchEvent ACTION_DO","123");
                break;
            case MotionEvent.ACTION_MOVE:
                Log.d("onTouchEvent","123");
                break;
            case MotionEvent.ACTION_UP:
                Log.d("onTouchEvent ACTION_UP","123");
                break;
        }
        if (flag == true)
           Toast.makeText(getContext(),"摸我了",Toast.LENGTH_LONG).show();
        return true;
    }
